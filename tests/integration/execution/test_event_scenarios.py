...
""",
    ...
    async def scenario() -> None:
        async with harness:
            ...
            assert tool_begin.given.summary == "calling math__double 3"
            assert isinstance(tool_end.noted, ToolStepNoted)
            assert tool_end.noted.summary == "called math__double 3"
            ...
            assert stored_tool.given.summary == "calling math__double 3"
            assert stored_tool.noted == ToolStepNoted(summary="called math__double 3")
