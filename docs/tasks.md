...
Lifecycle is expressed by folder placement, not by frontmatter:

| Folder | Lifecycle | Meaning |
| --- | --- | --- |
...
Lifecycle endpoints move definition files between folders. Execution endpoints
