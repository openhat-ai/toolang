...
Its plugin depends only on base contracts, never the Store or executor. Blocking
reads run in a worker thread; interruption discards delivery of the read result.
