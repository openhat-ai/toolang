...
square-cornered bottom border; the summary surface forms its visual top. Both
surfaces wrap like code blocks and fill the available progress width up to
...
ownership of their actual colors.
