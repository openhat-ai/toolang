...
accent. The status bar has no persistent left accent. It keeps the model name
aligned while a four-cell, background-only comet enters through the leading
space and sweeps across the model name and trailing space; there is no separate
