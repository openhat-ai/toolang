...
PY_LOG=toolang.execution=info toolang ./examples/workflows/proposal_workshop.too workshop -- "Propose a weekly release process"
toolang ./examples/workflows/proposal_workshop.too --help
toolang ./examples/workflows/proposal_workshop.too workshop -- "Propose a weekly release process"
toolang serve alice
...
toolang info alice
toolang alice info
toolang ./examples/workflows/deep_search.too info
toolang alice chat
